...
public record ResponseContext(string Profile, SupportingContentRecord[]? DataPoints, ThoughtRecord[] Thoughts, Guid MessageId, Guid ChatId, Guid ThreadId, Diagnostics? Diagnostics);
