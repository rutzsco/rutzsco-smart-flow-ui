...
resource existingKeyVaultResource 'Microsoft.KeyVault/vaults@2021-11-01-preview' existing = {
...
output name string = existingKeyVaultResource.name
output resourceGroupName string = ''
output id string = existingKeyVaultResource.id
output userManagedIdentityId string = ''
output endpoint string = existingKeyVaultResource.properties.vaultUri
